...
enum { SchemeNorm, SchemeSel, SchemeUrg, SchemeTitle, SchemeStaon, SchemeStaoff, SchemePowel }; /* color schemes add statuscolor support*/
...
//		strcpy(stext, "dwm-"VERSION);
		strcpy(stext, "   welcome to lalala-pc   ");
	drawbar(selmon);
}
